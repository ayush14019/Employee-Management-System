...
//       <div className="bg-linear-to-r from-[#1a1a1a] to-[#252525] rounded-2xl p-8 shadow-2xl border border-gray-800">
...
//             <button
//               type="submit"
//               className="bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 py-4 px-6 rounded-xl text-sm font-semibold mt-6 w-full transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-emerald-500/25"
//             >
//               Create Task
//             </button>
//           </div>
  ...
  return (
    <div className=" w-full  bg-[#0a0a0a]">
      ...
      <div className="mt-10 mb-10 max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-2xl p-8 shadow-2xl border border-gray-800">
          <form className="w-full flex flex-wrap gap-8">
            <div className="flex-1 min-w-[300px] space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
            ...
            <div className="flex-1 min-w-[300px] flex flex-col">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 py-4 px-6 rounded-xl text-sm font-semibold mt-6 w-full transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-emerald-500/25"
              >
                Create Task
              </button>
            </div>
