...
const CompleteTask = ({ data }) => {
  return (
    <div className="shrink-0 w-[348px] p-5 rounded-2xl bg-linear-to-br from-blue-500 to-sky-600 text-white shadow-lg hover:shadow-2xl transition-transform transform hover:scale-[1.02]">
      {/* Header */}
